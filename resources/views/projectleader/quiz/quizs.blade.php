                                    ...
                                    <div id="accordion" class="accordion">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <select class="form-control" name="module_1" required>
                                                                            ...
                                                                            @php
                                                                                $resourceData = DB::select("SELECT * FROM resources WHERE createdby_user_id = ?", [Auth::user()->id]);
                                                                            @endphp
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <input type="text" name="module_1_completion_percentage" placeholder="Module Percentage" class="form-control"  required>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xl-12">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <input type="text" name="module_2_completion_percentage" placeholder="Module Percentage" class="form-control" required>
                                                                    <small>% required to pass</small>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xl-12">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <input type="text" name="module_3_completion_percentage" placeholder="Module Percentage" class="form-control" required>
                                                                    <small>% required to pass</small>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xl-12">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <input type="text" name="module_4_completion_percentage" placeholder="Module Percentage" class="form-control" required>
                                                                    <small>% required to pass</small>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xl-12">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <input type="text" name="module_5_completion_percentage" placeholder="Module Percentage" class="form-control" required>
                                                                    <small>% required to pass</small>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xl-12">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <input type="text" name="module_6_completion_percentage" placeholder="Module Percentage" class="form-control" required>
                                                                    <small>% required to pass</small>
                                                                    </div>
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="card cardmodule">
                                            <div class="card-header" id="heading7">
                                                <h5 class="mb-0">
                                                    <a class="btn btn-link btn-block btn-success text-white" data-toggle="collapse" data-target="#collapse7" aria-expanded="true" aria-controls="collapse7">
                                                        Module 7
                                                        <i class="fe fe-plus ml-2 float-right"></i> 
                                                        <i class="fe fe-minus ml-2 float-right d-none"></i> 
                                                    </a>
                                            ...
                                            <div id="collapse7" class="collapse show" aria-labelledby="heading7" data-parent="#accordion">
                                                <div class="card-body">
                                                    <div class="module">
                                                        <div class="row">
                                                            <div class="col-xl-12">
                                                                <h4 class="card-title">Module 7</h6>
                                                                <div class="form-group row">
                                                                    <label class="col-lg-3 col-form-label">Module Name</label>
                                                                    <div class="col-lg-6">
                                                                        <select class="form-control" name="module_7" required>
                                                                            <option>-- Select Resource --</option>
                                                                            @php
                                                                                $resourceData = DB::select("SELECT * FROM resources WHERE createdby_user_id = ?", [Auth::user()->id]);
                                                                            @endphp
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <input type="text" name="module_7_completion_percentage" placeholder="Module Percentage" class="form-control" required>
                                                                    <small>% required to pass</small>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-10 offset-md-2">
                                                                <div class="mcq-container">
                                                                    <div id="accordion7" class="col-xl-12 mcq accordion7 mcq">
                                                                        <!-- MCQ sections will be dynamically added here -->
                                                                    </div>
                                                                </div>
                                                                <button type="button" class="btn btn-success add-mcq float-right" data-modulesid="7">Add MCQ</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card cardmodule">
                                            <div class="card-header" id="heading8">
                                                <h5 class="mb-0">
                                                    <a class="btn btn-link btn-block btn-success text-white" data-toggle="collapse" data-target="#collapse8" aria-expanded="true" aria-controls="collapse8">
                                                        Module 8
                                                        <i class="fe fe-plus ml-2 float-right"></i> 
                                                        <i class="fe fe-minus ml-2 float-right d-none"></i> 
                                                    </a>
                                            ...
                                            <div id="collapse8" class="collapse show" aria-labelledby="heading8" data-parent="#accordion">
                                                <div class="card-body">
                                                    <div class="module">
                                                        <div class="row">
                                                            <div class="col-xl-12">
                                                                <h4 class="card-title">Module 8</h4>
                                                                <div class="form-group row">
                                                                    <label class="col-lg-3 col-form-label">Module Name</label>
                                                                    <div class="col-lg-6">
                                                                        <select class="form-control" name="module_8" required>
                                                                            <option>-- Select Resource --</option>
                                                                            @php
                                                                                $resourceData = DB::select("SELECT * FROM resources WHERE createdby_user_id = ?", [Auth::user()->id]);
                                                                            @endphp
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <input type="text" name="module_8_completion_percentage" placeholder="Module Percentage" class="form-control" required>
                                                                    <small>% required to pass</small>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-10 offset-md-2">
                                                                <div class="mcq-container">
                                                                    <div id="accordion8" class="col-xl-12 mcq accordion8 mcq">
                                                                        <!-- MCQ sections will be dynamically added here -->
                                                                    </div>
                                                                </div>
                                                                <button type="button" class="btn btn-success add-mcq float-right" data-modulesid="8">Add MCQ</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card cardmodule">
                                            <div class="card-header" id="heading9">
                                                <h5 class="mb-0">
                                                    <a class="btn btn-link btn-block btn-success text-white" data-toggle="collapse" data-target="#collapse9" aria-expanded="true" aria-controls="collapse9">
                                                        Module 9
                                                        <i class="fe fe-plus ml-2 float-right"></i> 
                                                        <i class="fe fe-minus ml-2 float-right d-none"></i> 
                                                    </a>
                                            ...
                                            <div id="collapse9" class="collapse show" aria-labelledby="heading9" data-parent="#accordion">
                                                <div class="card-body">
                                                    <div class="module">
                                                        <div class="row">
                                                            <div class="col-xl-12">
                                                                <h4 class="card-title">Module 9</h6>
                                                                <div class="form-group row">
                                                                    <label class="col-lg-3 col-form-label">Module Name</label>
                                                                    <div class="col-lg-6">
                                                                        <select class="form-control" name="module_9" required>
                                                                            <option>-- Select Resource --</option>
                                                                            @php
                                                                                $resourceData = DB::select("SELECT * FROM resources WHERE createdby_user_id = ?", [Auth::user()->id]);
                                                                            @endphp
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <input type="text" name="module_9_completion_percentage" placeholder="Module Percentage" class="form-control" required>
                                                                    <small>% required to pass</small>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-10 offset-md-2">
                                                                <div class="mcq-container">
                                                                    <div id="accordion9" class="col-xl-12 mcq accordion9 mcq">
                                                                        <!-- MCQ sections will be dynamically added here -->
                                                                    </div>
                                                                </div>
                                                                <button type="button" class="btn btn-success add-mcq float-right" data-modulesid="9">Add MCQ</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card cardmodule">
                                            <div class="card-header" id="heading10">
                                                <h5 class="mb-0">
                                                    <a class="btn btn-link btn-block btn-success text-white" data-toggle="collapse" data-target="#collapse10" aria-expanded="true" aria-controls="collapse10">
                                                        Module 10
                                                        <i class="fe fe-plus ml-2 float-right"></i> 
                                                        <i class="fe fe-minus ml-2 float-right d-none"></i> 
                                                    </a>
                                            ...
                                            <div id="collapse10" class="collapse show" aria-labelledby="heading10" data-parent="#accordion">
                                                <div class="card-body">
                                                    <div class="module">
                                                        <div class="row">
                                                            <div class="col-xl-12">
                                                                <h4 class="card-title">Module 10</h6>
                                                                <div class="form-group row">
                                                                    <label class="col-lg-3 col-form-label">Module Name</label>
                                                                    <div class="col-lg-6">
                                                                        <select class="form-control" name="module_10" required>
                                                                            <option>-- Select Resource --</option>
                                                                            @php
                                                                                $resourceData = DB::select("SELECT * FROM resources WHERE createdby_user_id = ?", [Auth::user()->id]);
                                                                            @endphp
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <input type="text" name="module_10_completion_percentage" placeholder="Module Percentage" class="form-control" required>
                                                                    <small>% required to pass</small>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-10 offset-md-2">
                                                                <div class="mcq-container">
                                                                    <div id="accordion10" class="col-xl-12 mcq accordion10 mcq">
                                                                        <!-- MCQ sections will be dynamically added here -->
                                                                    </div>
                                                                </div>
                                                                <button type="button" class="btn btn-success add-mcq float-right" data-modulesid="10">Add MCQ</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card cardmodule">
                                            <div class="card-header" id="heading11">
                                                <h5 class="mb-0">
                                                    <a class="btn btn-link btn-block btn-success text-white" data-toggle="collapse" data-target="#collapse11" aria-expanded="true" aria-controls="collapse11">
                                                        Module 11
                                                        <i class="fe fe-plus ml-2 float-right"></i> 
                                                        <i class="fe fe-minus ml-2 float-right d-none"></i> 
                                                    </a>
                                            ...
                                            <div id="collapse11" class="collapse show" aria-labelledby="heading11" data-parent="#accordion">
                                                <div class="card-body">
                                                    <div class="module">
                                                        <div class="row">
                                                            <div class="col-xl-12">
                                                                <h4 class="card-title">Module 11</h6>
                                                                <div class="form-group row">
                                                                    <label class="col-lg-3 col-form-label">Module Name</label>
                                                                    <div class="col-lg-6">
                                                                        <select class="form-control" name="module_11" required>
                                                                            <option>-- Select Resource --</option>
                                                                            @php
                                                                                $resourceData = DB::select("SELECT * FROM resources WHERE createdby_user_id = ?", [Auth::user()->id]);
                                                                            @endphp
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <input type="text" name="module_11_completion_percentage" placeholder="Module Percentage" class="form-control" required>
                                                                    <small>% required to pass</small>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-10 offset-md-2">
                                                                <div class="mcq-container">
                                                                    <div id="accordion11" class="col-xl-12 mcq accordion11 mcq">
                                                                        <!-- MCQ sections will be dynamically added here -->
                                                                    </div>
                                                                </div>
                                                                <button type="button" class="btn btn-success add-mcq float-right" data-modulesid="11">Add MCQ</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="card">
                                ...
                                <div id="collapse${moduleIndex}mcq${mcqNumber}" class="collapse show" aria-labelledby="heading${moduleIndex}mcq${mcqNumber}" data-parent="#accordion${moduleIndex}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <select name="module_${moduleIndex}_quiz[mcqs][${mcqNumber}][correct_answer]" class="form-control" required>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label">Correct Answer Explanation</label>
                                        <div class="col-lg-9">
                                            <textarea name="module_${moduleIndex}_quiz[mcqs][${mcqNumber}][correct_answer_explanation]" placeholder="Correct Answer Explanation "  class="form-control" required > </textarea>
                                            <small>Max character limit 250.</small>    
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label">Brand Image Name</label>
                                        <div class="col-lg-9">
                                            <input type="text" name="module_${moduleIndex}_quiz[mcqs][${mcqNumber}][brandimage]" placeholder="Enter Brand Image Name with Extension"  class="form-control" required >
                                            <small>Max character limit 250.</small>    
                                        </div>
                                    </div>
                                    <!--
